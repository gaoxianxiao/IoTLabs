...
<div class="crumb_warp">
    ...
    <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo;  添加产品
</div>
<!--面包屑导航 结束-->
    ...
    <form action="{{url('admin/type')}}" method="post">
        ...
        <table class="add_tab">
            ...
            <tr>
                <th>APIKEY：</th>
                <td>
                    <input type="text" name="type_apikey">
            ...
            <tr>
                <th>解析脚本：</th>
                <td>
                    <input type="text" name="type_parsername">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="sm" name="type_order">
                </td>
            </tr>
            <tr>
                <th></th>
