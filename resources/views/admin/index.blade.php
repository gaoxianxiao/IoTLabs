...
<div class="menu_box">
	<ul>
		<li>
			<h3><i class="fa fa-fw fa-clipboard"></i>设备管理</h3>
			<ul class="sub_menu">
				<li><a href="{{url('admin/type/create')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>添加产品</a></li>
				<li><a href="{{url('admin/type')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>产品列表</a></li>
				<li><a href="{{url('admin/device/create')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>添加设备</a></li>
				<li><a href="{{url('admin/device')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>设备列表</a></li>
			</ul>
		</li>
		<li>
		...
		<li>
			...
			<ul class="sub_menu" style="display: block;">
				<li><a href="{{url('admin/custom')}}" target="main"><i class="fa fa-fw fa-cubes"></i>客户信息</a></li>
...
<div class="bottom_box">
	CopyRight © 2018. Powered By <a href="http://www.iotlabs.cn">http://www.iotlabs.cn</a>.
</div>
<!--底部 结束-->
@endsection
